 ...
 * Simple Navwalker
 *
 * Fork of bootstrap-5-wordpress-navbar-walker
 *
 ...
 * Simple Navwalker
 */
class Simple_Navwalker extends \Walker_Nav_Menu {
	/**
	 * Current menu item
	 *
	...
	/**
	 * Bootstrap Dropdown menu alignment values
	 *
	...
	public function start_el( &$output, $item, $depth = 0, $args = null, $id = 0 ) {
		...
		$nav_link_class = ( $depth > 0 ) ? 'dropdown-item ' : 'nav-link text-uppercase ';
