	...
	<div class="container z-2 position-relative">
		<div class="row d-flex align-items-center">
			...
			<div class="col-12 col-lg-6 text-white my-5 p-5">
				...
				<small data-aos="fade-down" class="d-inline-block quote-attribution bg-white border border-3 border-black p-3 text-black">Courtesy of <a
						href="https://press.disneyplus.com/media-kits/echo" target="_blank" rel="noopener noreferrer">Disney Media Kit</a></small>
